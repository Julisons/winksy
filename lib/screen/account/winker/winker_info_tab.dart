...
class WinkerInfoTab extends StatelessWidget {
  const WinkerInfoTab({super.key});

  @override
  Widget build(BuildContext context) {
    final color = Theme.of(context).extension<CustomColors>()!;
    final winkser = Mixin.winkser;
      ...
      child: Column(
        children: [
          ...
          _buildInfoCard(
            ...
            [
              InfoItem("Full Name", winkser?.usrFullNames ?? '', Icons.badge_outlined),
              InfoItem("Email Address", '****************', Icons.email_outlined),
              InfoItem("Age", '${winkser?.usrDob != null ? '${winkser?.usrDob}'.age() : 0} Years', Icons.cake_outlined),
              InfoItem("Gender", winkser?.usrGender ?? '', Icons.wc_outlined),
            ],
          ),
          ...
          _buildInfoCard(
            ...
            [
              InfoItem("Phone Number", '****************', Icons.phone_outlined),
              InfoItem("Location", "${winkser?.usrCountry ?? ''}, ${winkser?.usrAdministrativeArea ?? ''}", Icons.place_outlined),
            ],
          ),
          ...
          // About Me Card
          _buildAboutCard(context, "About Me", winkser?.usrDesc ?? ''),
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: color.xSecondaryColor.withOpacity(0.3),
                borderRadius: BorderRadius.circular(8.r),
                border: Border.all(
                  color: color.xTextColor.withOpacity(0.1),
                  width: 1,

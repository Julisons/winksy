...
class IMatchCard extends StatefulWidget {
  const IMatchCard({super.key, required this.user, required this.onRefresh, required this.text});
  final User user;
  final VoidCallback onRefresh;
  final String text;

  @override
  State<IMatchCard> createState() => _IMatchCardState();
}

class _IMatchCardState extends State<IMatchCard> {
  @override
              ...
              Positioned(
                ...
                child: Text(
                  widget.user.usrDistance == null || widget.user.usrDistance.isEmpty
                      ...
                      : '${widget.user.usrDistance} (${widget.user.usrLocality})',
                  style: TextStyle(
                    color: Colors.white,

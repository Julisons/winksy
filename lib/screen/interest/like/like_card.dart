...
class ILikeCard extends StatefulWidget {
  const ILikeCard({super.key, required this.user, required this.onRefresh, required this.text});
  final User user;
  final VoidCallback onRefresh;
  final String text;

  @override
  State<ILikeCard> createState() => _ILikeCardState();
}

class _ILikeCardState extends State<ILikeCard> {
  @override
